...
methods = {
    "MOG2": cv.createBackgroundSubtractorMOG2(),
        # grade:3, Improved Gaussian Mixture Model. Decent for low-resolution, supports shadow detection, but struggles with noise.",
    ...
    #     "grade:5, Efficient and faster background subtraction. Very fast and lightweight, but less accurate in noisy, low-resolution environments.",
